...
import (
	...
	"github.com/mhiro2/seedling/integration/sqlite/testutil"
...
func TestSQLiteInsertOne_PersistsResolvedDependencies(t *testing.T) {
	// Arrange
...
func TestSQLiteInsertManySeq_PersistsGeneratedNames(t *testing.T) {
	// Arrange
	h := testutil.NewHarness(t)
	db := h.DB
	reg := h.Registry
...
func TestSQLiteInsertOneE_ReturnsForeignKeyViolation(t *testing.T) {
	// Arrange
	h := testutil.NewHarness(t)
	db := h.DB
	reg := h.Registry
...
func TestSQLiteInsertOneE_ReturnsConnectionError(t *testing.T) {
	// Arrange
	h := testutil.NewHarness(t)
	db := h.DB
	reg := h.Registry
...
func TestSQLiteInsertOne_RollsBackTransaction(t *testing.T) {
	// Arrange
	h := testutil.NewHarness(t)
	db := h.DB
	reg := h.Registry
...
func TestSQLiteInsertOne_HasManyPersistsResolvedDependencies(t *testing.T) {
	// Arrange
	h := testutil.NewHarness(t)
	db := h.DB
	reg := h.Registry
...
func TestSQLiteInsertOne_CompositePKPersistsResolvedDependencies(t *testing.T) {
	// Arrange
	h := testutil.NewHarness(t)
	db := h.DB
	reg := h.Registry
...
func TestSQLiteInsertOne_ManyToManyPersistsResolvedDependencies(t *testing.T) {
	// Arrange
	h := testutil.NewHarness(t)
	db := h.DB
	reg := h.Registry
